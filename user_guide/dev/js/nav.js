function create_menu(basepath)
{
	...
	document.write(
		...
		'<ul>' +
            ...
            '<li><a href="'+base+'docs-database.html#selects">Selects</a></li>' +
            '<li><a href="'+base+'docs-database.html#inserts">Inserts</a></li>' + 
            '<li><a href="'+base+'docs-database.html#updates">Updates</a></li>' +
